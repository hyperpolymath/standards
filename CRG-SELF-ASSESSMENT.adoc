...
| Unit tests
| Present
| a2ml/bindings/rust (47), self-validating/bindings/rust (45), mcp-repo-guardian (36), axel-protocol (14), groove-protocol (10), avow-protocol/src (8)
...
| Property-based (P2P)
| Present
| proptest in a2ml + self-validating Rust crates (parse/render roundtrip)
...
| Contract (pre/post)
| Present
| a2ml + self-validating pre/post-condition validation; avow-lib Idris2 dependent-type proofs
...
| Present
| criterion for a2ml + self-validating; zig bench for groove-protocol grv6
|===
