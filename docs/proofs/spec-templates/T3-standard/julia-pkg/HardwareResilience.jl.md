# Proof Spec: HardwareResilience.jl
<!-- SPDX-License-Identifier: AGPL-3.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/HardwareResilience.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/HardwareResilience.jl
...
- [ ] Commit: `proof: complete HardwareResilience.jl proofs`
