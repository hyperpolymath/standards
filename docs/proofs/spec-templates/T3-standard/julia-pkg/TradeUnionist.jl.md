# Proof Spec: TradeUnionist.jl
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/TradeUnionist.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/TradeUnionist.jl
...
- [ ] Commit: `proof: complete TradeUnionist.jl proofs`
