# Proof Spec: InvestigativeJournalist.jl
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/InvestigativeJournalist.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/InvestigativeJournalist.jl
...
- [ ] Commit: `proof: complete InvestigativeJournalist.jl proofs`
