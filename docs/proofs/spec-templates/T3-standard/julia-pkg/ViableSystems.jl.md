# Proof Spec: ViableSystems.jl
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/ViableSystems.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/ViableSystems.jl
...
- [ ] Commit: `proof: complete ViableSystems.jl proofs`
