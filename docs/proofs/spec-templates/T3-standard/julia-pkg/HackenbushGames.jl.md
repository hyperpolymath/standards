# Proof Spec: HackenbushGames.jl
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/HackenbushGames.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/HackenbushGames.jl
...
- [ ] Commit: `proof: complete HackenbushGames.jl proofs`
