# Proof Spec: SoftwareSovereign.jl
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/SoftwareSovereign.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/SoftwareSovereign.jl
...
- [ ] Commit: `proof: complete SoftwareSovereign.jl proofs`
