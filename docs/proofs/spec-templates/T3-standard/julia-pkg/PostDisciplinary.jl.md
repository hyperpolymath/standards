# Proof Spec: PostDisciplinary.jl
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/PostDisciplinary.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/PostDisciplinary.jl
...
- [ ] Commit: `proof: complete PostDisciplinary.jl proofs`
