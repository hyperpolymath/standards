# Proof Spec: JuliaPackage-Reuse-Audit.jl
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/JuliaPackage-Reuse-Audit.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/JuliaPackage-Reuse-Audit.jl
...
- [ ] Commit: `proof: complete JuliaPackage-Reuse-Audit.jl proofs`
