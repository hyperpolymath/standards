# Proof Spec: Hyperpolymath.jl
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/Hyperpolymath.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/Hyperpolymath.jl
...
- [ ] Commit: `proof: complete Hyperpolymath.jl proofs`
