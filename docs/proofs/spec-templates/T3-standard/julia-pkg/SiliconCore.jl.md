# Proof Spec: SiliconCore.jl
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/SiliconCore.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/SiliconCore.jl
...
- [ ] Commit: `proof: complete SiliconCore.jl proofs`
