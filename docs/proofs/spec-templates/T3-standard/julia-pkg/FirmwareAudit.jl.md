# Proof Spec: FirmwareAudit.jl
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/FirmwareAudit.jl`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/FirmwareAudit.jl
...
- [ ] Commit: `proof: complete FirmwareAudit.jl proofs`
