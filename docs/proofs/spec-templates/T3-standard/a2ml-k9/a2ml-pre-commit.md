# Proof Spec: a2ml-pre-commit
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/a2ml-pre-commit`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/a2ml-pre-commit
...
- [ ] Commit: `proof: complete a2ml-pre-commit proofs`
