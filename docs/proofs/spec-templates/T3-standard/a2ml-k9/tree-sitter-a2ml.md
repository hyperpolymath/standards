# Proof Spec: tree-sitter-a2ml
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/tree-sitter-a2ml`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/tree-sitter-a2ml
...
- [ ] Commit: `proof: complete tree-sitter-a2ml proofs`
