# Proof Spec: tree-sitter-k9
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/tree-sitter-k9`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/tree-sitter-k9
...
- [ ] Commit: `proof: complete tree-sitter-k9 proofs`
