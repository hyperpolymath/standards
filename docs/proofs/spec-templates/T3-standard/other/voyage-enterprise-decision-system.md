# Proof Spec: voyage-enterprise-decision-system
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/voyage-enterprise-decision-system`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/voyage-enterprise-decision-system
...
- [ ] Commit: `proof: complete voyage-enterprise-decision-system proofs`
