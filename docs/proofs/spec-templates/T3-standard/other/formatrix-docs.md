# Proof Spec: formatrix-docs
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/formatrix-docs`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/formatrix-docs
...
- [ ] Commit: `proof: complete formatrix-docs proofs`
