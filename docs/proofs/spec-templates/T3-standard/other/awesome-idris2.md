# Proof Spec: awesome-idris2
<!-- SPDX-License-Identifier: AGPL-3.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/awesome-idris2`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/awesome-idris2
...
- [ ] Commit: `proof: complete awesome-idris2 proofs`
