# Proof Spec: nextgen-databases
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/nextgen-databases`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/nextgen-databases
...
- [ ] Commit: `proof: complete nextgen-databases proofs`
