# Proof Spec: excel-economic-numbers-tool
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/excel-economic-numbers-tool`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/excel-economic-numbers-tool
...
- [ ] Commit: `proof: complete excel-economic-numbers-tool proofs`
