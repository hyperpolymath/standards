# Proof Spec: game-server-admin
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/game-server-admin`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/game-server-admin
...
- [ ] Commit: `proof: complete game-server-admin proofs`
