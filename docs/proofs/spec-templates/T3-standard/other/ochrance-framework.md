# Proof Spec: ochrance-framework
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/ochrance-framework`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/ochrance-framework
...
- [ ] Commit: `proof: complete ochrance-framework proofs`
