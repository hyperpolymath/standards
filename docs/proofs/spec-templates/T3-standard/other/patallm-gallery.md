# Proof Spec: patallm-gallery
<!-- SPDX-License-Identifier: AGPL-3.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/patallm-gallery`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/patallm-gallery
...
- [ ] Commit: `proof: complete patallm-gallery proofs`
