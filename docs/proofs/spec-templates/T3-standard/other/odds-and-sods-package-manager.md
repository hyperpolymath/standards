# Proof Spec: odds-and-sods-package-manager
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/odds-and-sods-package-manager`
**Tier**: T3 — Standard
...
- [ ] Commit: `proof: complete odds-and-sods-package-manager proofs`
