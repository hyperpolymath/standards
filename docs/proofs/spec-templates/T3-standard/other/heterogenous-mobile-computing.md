# Proof Spec: heterogenous-mobile-computing
<!-- SPDX-License-Identifier: AGPL-3.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/heterogenous-mobile-computing`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/heterogenous-mobile-computing
...
- [ ] Commit: `proof: complete heterogenous-mobile-computing proofs`
