# Proof Spec: ssg-collection
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/ssg-collection`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/ssg-collection
...
- [ ] Commit: `proof: complete ssg-collection proofs`
