# Proof Spec: developer-ecosystem
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/developer-ecosystem`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/developer-ecosystem
...
- [ ] Commit: `proof: complete developer-ecosystem proofs`
