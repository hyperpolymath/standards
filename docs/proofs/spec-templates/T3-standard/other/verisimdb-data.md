# Proof Spec: verisimdb-data
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/verisimdb-data`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/verisimdb-data
...
- [ ] Commit: `proof: complete verisimdb-data proofs`
