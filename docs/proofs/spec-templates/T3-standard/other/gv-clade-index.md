# Proof Spec: gv-clade-index
<!-- SPDX-License-Identifier: AGPL-3.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/gv-clade-index`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/gv-clade-index
...
- [ ] Commit: `proof: complete gv-clade-index proofs`
