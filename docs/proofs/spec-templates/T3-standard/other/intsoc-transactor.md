# Proof Spec: intsoc-transactor
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/intsoc-transactor`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/intsoc-transactor
...
- [ ] Commit: `proof: complete intsoc-transactor proofs`
