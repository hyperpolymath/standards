# Proof Spec: tree-navigator
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/tree-navigator`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/tree-navigator
...
- [ ] Commit: `proof: complete tree-navigator proofs`
