# Proof Spec: misinformation-defence-platform
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/misinformation-defence-platform`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/misinformation-defence-platform
...
- [ ] Commit: `proof: complete misinformation-defence-platform proofs`
