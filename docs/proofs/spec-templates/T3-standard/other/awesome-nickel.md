# Proof Spec: awesome-nickel
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/awesome-nickel`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/awesome-nickel
...
- [ ] Commit: `proof: complete awesome-nickel proofs`
