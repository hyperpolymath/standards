# Proof Spec: nickel-augmentation
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/nickel-augmentation`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/nickel-augmentation
...
- [ ] Commit: `proof: complete nickel-augmentation proofs`
