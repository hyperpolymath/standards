# Proof Spec: format-registrations
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/format-registrations`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/format-registrations
...
- [ ] Commit: `proof: complete format-registrations proofs`
