# Proof Spec: no-nonsense-nntps
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/no-nonsense-nntps`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/no-nonsense-nntps
...
- [ ] Commit: `proof: complete no-nonsense-nntps proofs`
