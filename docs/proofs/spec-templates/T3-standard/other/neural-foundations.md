# Proof Spec: neural-foundations
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/neural-foundations`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/neural-foundations
...
- [ ] Commit: `proof: complete neural-foundations proofs`
