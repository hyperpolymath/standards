# Proof Spec: squisher-corpus
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/squisher-corpus`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/squisher-corpus
...
- [ ] Commit: `proof: complete squisher-corpus proofs`
