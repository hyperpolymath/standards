# Proof Spec: rescript-evangeliser
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/rescript-evangeliser`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/rescript-evangeliser
...
- [ ] Commit: `proof: complete rescript-evangeliser proofs`
