# Proof Spec: branch-newspaper
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/branch-newspaper`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/branch-newspaper
...
- [ ] Commit: `proof: complete branch-newspaper proofs`
