# Proof Spec: accessibility-everywhere
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/accessibility-everywhere`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/accessibility-everywhere
...
- [ ] Commit: `proof: complete accessibility-everywhere proofs`
