# Proof Spec: feedback-o-tron
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/feedback-o-tron`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/feedback-o-tron
...
- [ ] Commit: `proof: complete feedback-o-tron proofs`
