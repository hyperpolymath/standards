# Proof Spec: git-reticulator
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/git-reticulator`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/git-reticulator
...
- [ ] Commit: `proof: complete git-reticulator proofs`
