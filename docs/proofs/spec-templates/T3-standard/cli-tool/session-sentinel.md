# Proof Spec: session-sentinel
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/session-sentinel`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/session-sentinel
...
- [ ] Commit: `proof: complete session-sentinel proofs`
