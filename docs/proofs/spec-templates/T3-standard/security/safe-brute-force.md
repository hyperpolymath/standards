# Proof Spec: safe-brute-force
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/safe-brute-force`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/safe-brute-force
...
- [ ] Commit: `proof: complete safe-brute-force proofs`
