# Proof Spec: cookie-rebound
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/cookie-rebound`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/cookie-rebound
...
- [ ] Commit: `proof: complete cookie-rebound proofs`
