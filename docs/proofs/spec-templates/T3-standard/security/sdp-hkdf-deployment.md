# Proof Spec: sdp-hkdf-deployment
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/sdp-hkdf-deployment`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/sdp-hkdf-deployment
...
- [ ] Commit: `proof: complete sdp-hkdf-deployment proofs`
