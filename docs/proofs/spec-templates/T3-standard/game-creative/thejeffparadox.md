# Proof Spec: thejeffparadox
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/thejeffparadox`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/thejeffparadox
...
- [ ] Commit: `proof: complete thejeffparadox proofs`
