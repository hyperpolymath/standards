# Proof Spec: rrecord-verity
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/rrecord-verity`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/rrecord-verity
...
- [ ] Commit: `proof: complete rrecord-verity proofs`
