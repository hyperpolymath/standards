# Proof Spec: hesiod-dns-map
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/hesiod-dns-map`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/hesiod-dns-map
...
- [ ] Commit: `proof: complete hesiod-dns-map proofs`
