# Proof Spec: universal-language-server-plugin
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/universal-language-server-plugin`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/universal-language-server-plugin
...
- [ ] Commit: `proof: complete universal-language-server-plugin proofs`
