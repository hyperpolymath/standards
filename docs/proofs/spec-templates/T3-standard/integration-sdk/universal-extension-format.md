# Proof Spec: universal-extension-format
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/universal-extension-format`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/universal-extension-format
...
- [ ] Commit: `proof: complete universal-extension-format proofs`
