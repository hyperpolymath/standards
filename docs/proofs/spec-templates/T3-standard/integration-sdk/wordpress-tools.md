# Proof Spec: wordpress-tools
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/wordpress-tools`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/wordpress-tools
...
- [ ] Commit: `proof: complete wordpress-tools proofs`
