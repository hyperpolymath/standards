# Proof Spec: elixir-mcp-server
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/elixir-mcp-server`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/elixir-mcp-server
...
- [ ] Commit: `proof: complete elixir-mcp-server proofs`
