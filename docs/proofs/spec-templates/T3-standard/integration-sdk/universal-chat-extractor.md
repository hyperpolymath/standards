# Proof Spec: universal-chat-extractor
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/universal-chat-extractor`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/universal-chat-extractor
...
- [ ] Commit: `proof: complete universal-chat-extractor proofs`
