# Proof Spec: unified-dataset-vocab
<!-- SPDX-License-Identifier: CC-BY-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/unified-dataset-vocab`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/unified-dataset-vocab
...
- [ ] Commit: `proof: complete unified-dataset-vocab proofs`
