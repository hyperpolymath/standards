# Proof Spec: thunderbird-template-reloaded
<!-- SPDX-License-Identifier: CC-BY-SA-4.0 -->

**Repo Path**: `/var/mnt/eclipse/repos/thunderbird-template-reloaded`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/thunderbird-template-reloaded
...
- [ ] Commit: `proof: complete thunderbird-template-reloaded proofs`
