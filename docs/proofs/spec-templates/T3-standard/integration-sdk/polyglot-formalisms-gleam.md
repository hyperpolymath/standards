# Proof Spec: polyglot-formalisms-gleam
<!-- SPDX-License-Identifier: PMPL-1.0-or-later -->

**Repo Path**: `/var/mnt/eclipse/repos/polyglot-formalisms-gleam`
**Tier**: T3 — Standard
...
```bash
cd /var/mnt/eclipse/repos/polyglot-formalisms-gleam
...
- [ ] Commit: `proof: complete polyglot-formalisms-gleam proofs`
