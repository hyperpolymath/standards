...
`humans.txt`, REUSE `dep5`, and `CITATION.cff` (many still carrying `Jonathan D.A. Jewell`
...
A subset of 7a — mostly template `dep5` files with `Jonathan D.A. Jewell` placeholders.
