...
k9 out to `.machine_readable/self-validating/` (2026-04-18). The hook comment
...
k9 lives at `.machine_readable/self-validating/` in every repo. The
...
. If `.machine_readable/contractiles/k9/` exists and `.machine_readable/self-validating/`
