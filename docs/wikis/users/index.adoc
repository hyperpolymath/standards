...
=== 2. The machine-readable artefacts (descriptiles)
...
* `1-formats/A2ML-REPO-TEMPLATE.adoc` — the template to stand a repo up.
* `setup.sh` — bootstrap.
* `0-canon/TEMPLATE-APPLICABILITY-POLICY.adoc` — which parts apply to which repo shapes.
