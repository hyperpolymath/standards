...
* `2-protocols/avow/`, `2-protocols/axel/`, `2-protocols/overlay/`,
  `2-protocols/0-ai-gatekeeper/`. (Consent-Aware Web was extracted to `metadatastician/consent-aware-web` on 2026-08-07.)
