...
* `.claude/CLAUDE.md` (§License Policy) + `3-practice/LICENCE-POLICY.adoc`.
...
* `.machine_readable/REGISTRY.a2ml` and `TOPOLOGY.adoc` are *generated* by
...
* `scripts/build-registry.sh`, `just registry` / `just registry-check`,
  `REGISTRY.adoc`, `TOPOLOGY.adoc` (derived).
...
* `component-readiness-grades/` (+ ARG/FRG/TRG), `0-canon/CRG-SELF-ASSESSMENT.adoc`,
...
=== 5. The innervation / contractile stack (descriptiles)

* `.machine_readable/descriptiles/` (STATE/META/…), `1-formats/contractiles/`, `contractile.just`,
...
* `3-practice/release-pre-flight/`, `3-practice/publication-pre-flight/`, `just v1-audit`,
  `3-practice/MAINTAINERS.adoc`, `3-practice/CODEOWNERS-POLICY.adoc`, `3-practice/SECURITY.md`.
