...
=== Two loose ends, re-surfaced

. An earlier owner message cut off mid-sentence at "…certainly not hiding
  anything, and". It was never completed and no answer was given.
