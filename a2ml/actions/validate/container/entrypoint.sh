...
# a2ml-validate-action container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping a2ml-validate-action..."
...
echo "Starting a2ml-validate-action..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/a2ml-validate-action
#   exec /app/release/bin/a2ml-validate-action start
#   exec /app/a2ml-validate-action serve --host "${APP_HOST}" --port "${APP_PORT}"
