...
;;
;; Guix package definition for a2ml-validate-action
;;
;; Usage:
;;   guix shell -D -f guix.scm    # Enter development shell
;;   guix build -f guix.scm       # Build package
;;
;; TODO: Replace a2ml-validate-action and customize inputs for your language/stack.
...
(package
  ...
  (home-page "https://github.com/hyperpolymath/a2ml-validate-action")
  (synopsis "")
