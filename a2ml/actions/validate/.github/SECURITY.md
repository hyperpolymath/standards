...
Replace all {{PLACEHOLDER}} values with your information:
  a2ml-validate-action     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  a2ml-validate-action             - Repository name
  j.d.a.jewell@open.ac.uk   - Security contact email
  {{PGP_FINGERPRINT}}  - Your PGP key fingerprint (40 chars, no spaces)
  {{PGP_KEY_URL}}      - URL to your public PGP key
  https://github.com/hyperpolymath/a2ml-validate-action          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/a2ml-validate-action/security/advisories/new)
...
- This repository (`hyperpolymath/a2ml-validate-action`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/a2ml-validate-action/security/advisories)
...
When using a2ml-validate-action, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/a2ml-validate-action/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/a2ml-validate-action/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/a2ml-validate-action/discussions) |
...
*Thank you for helping keep a2ml-validate-action and its users safe.* 🛡️
