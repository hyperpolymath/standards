...
| *Bun*
| JS runtime & package management (tier 1)
...
| *npm/yarn*
| Bun
| Supply chain risks. npm is tier 3 — *permitted, never preferred* — rather
  ...
  and sits in §Allowed Languages. pnpm is tier 2, permitted only where an
...
3. **npm last.** Tier 3 — permitted, never preferred; reaching for it is a
