...
* [ ] 3-practice/SECURITY.md with vulnerability policy
...
* [ ] `.machine_readable/descriptiles/STATE.a2ml` - Project state tracking
* [ ] `.machine_readable/descriptiles/META.a2ml` - Architecture decisions
* [ ] `.machine_readable/descriptiles/ECOSYSTEM.a2ml` - Project relationships
* [ ] `.machine_readable/descriptiles/AGENTIC.a2ml` - AI agent constraints
