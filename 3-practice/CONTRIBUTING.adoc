...
MAINTAINERS.md ├── README.adoc ├── 3-practice/SECURITY.md ├── guix.scm # Guix manifest
...
[source,sh]
----
just registry     # regenerates REGISTRY.a2ml + TOPOLOGY.adoc
git add .machine_readable/REGISTRY.a2ml TOPOLOGY.adoc
----
