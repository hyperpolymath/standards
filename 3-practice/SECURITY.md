...
**The security policy for this repository lives in [`3-practice/SECURITY.adoc`](3-practice/SECURITY.adoc).**
...
disclosure policy. See also [`3-practice/SECURITY-ADVISORIES.adoc`](3-practice/SECURITY-ADVISORIES.adoc).
...
Several tools nonetheless look for the literal filename `3-practice/SECURITY.md` and
...
- `.github/workflows/scorecard-enforcer.yml`'s `check-critical` job runs
  `if [ ! -f "3-practice/SECURITY.md" ]` and **fails on every push** without it
...
to accept `3-practice/SECURITY.adoc`. That is the more consistent long-term answer and is
