...
# See hyperpolymath/standards 3-practice/CODEOWNERS-POLICY.adoc (Rule 1).
...
* `3-practice/LICENCE-POLICY.adoc` (this directory) — companion canonical policy; SPDX headers cover attribution
* `3-practice/MAINTAINERS.adoc` (this directory) — maintainer-of-record (separate from CODEOWNERS auto-ping)
