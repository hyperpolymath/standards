...
link:3-practice/ZIGZAG-TESTING.adoc[3-practice/ZIGZAG-TESTING.adoc] methodology.
...
The former `+2-protocols/groove/reference/ipv6t/+` Zig implementation was
...
`+2-protocols/0-ai-gatekeeper/mcp-repo-guardian/+`
...
Run: `+cargo test+` from
`+2-protocols/0-ai-gatekeeper/repo-guardian-fs/tests-offline/+`
...
0-AI-MANIFEST.a2ml, parse .machine_readable/descriptiles/STATE.a2ml (2 tests)
...
==== 1-formats/k9/bindings/rust — 45 tests (Rust)

Run: `+cargo test+` from `+1-formats/k9/bindings/rust/+`
...
*Benchmarks*: `+cargo bench+` from `+1-formats/k9/bindings/rust/+` - Parse
...
* [x] Added `+proptest+` + `+criterion+` dev-dependencies to
`+1-formats/k9/bindings/rust/Cargo.toml+`
...
* [x] Created `+1-formats/k9/bindings/rust/tests/crg_c_tests.rs+` — 33 tests
covering all CRG C categories
* [x] Created `+1-formats/k9/bindings/rust/benches/k9_bench.rs+` — Criterion
benchmarks (6 bench functions)
