...
Standardized Scheme-based state files for project metadata, ecosystem positioning, and operational configuration:
...
|`META.scm`
|Project metadata, architectural decisions (ADRs), development practices

|`ECOSYSTEM.scm`
|Ecosystem positioning, related projects, what-is/what-is-not

|`STATE.scm`
|Current project state, phase, compliance, milestones

|`PLAYBOOK.scm`
|Operational runbook, procedures, alerts, contacts

|`AGENTIC.scm`
|AI agent interaction patterns, Claude Code config, constraints
...
├── scm-templates/          # SCM state file templates
│   ├── META.scm.template
