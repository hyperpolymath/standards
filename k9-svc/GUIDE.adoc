...
.https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/config.k9.ncl
[source,nickel]
----
...
[source,bash]
----
nickel typecheck https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/config.k9.ncl
...
.https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/deploy.k9.ncl
[source,nickel]
----
let pedigree = import "../pedigree.ncl" in
...
----
# Sign with your key
just sign https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/deploy.k9.ncl alice

# Creates: https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/deploy.k9.ncl.sig
...
----
# Verify a component
just verify https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/deploy.k9.ncl
...
just authorize https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/deploy.k9.ncl
----
...
# Output: https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/hello.k9: K9 Self-Validating Component
----
...
See: `https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/config.k9.ncl` for a Yard-level configuration example.
...
Before wrapping something in k9-svc, read link:https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/NOT-a-good-fit.adoc[NOT-a-good-fit.adoc].
...
See: link:https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/NOT-a-good-fit.adoc[Comparison, Deprecation Analysis, and Anti-Patterns]
