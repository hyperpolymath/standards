...
cleanup() {
    echo "Received shutdown signal — stopping k9-validate-action..."
...
echo "Starting k9-validate-action..."
echo "  Host: ${APP_HOST:-[::]}"
...
# Examples:
#   exec /app/k9-validate-action
#   exec /app/release/bin/k9-validate-action start
#   exec /app/k9-validate-action serve --host "${APP_HOST}" --port "${APP_PORT}"
