...
// Replace standards, Standards — See README.adoc for details., just run, Standards started successfully. with actuals
= standards — Quick Start for Users
:toc:
:toclevels: 2

== What is standards?

Standards — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./standards-portable
----
...
[source]
----
Standards started successfully.
----
