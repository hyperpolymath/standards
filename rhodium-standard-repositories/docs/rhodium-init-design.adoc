...
│  [X] 3-practice/SECURITY.md                                          │
│  [X] 3-practice/CODE_OF_CONDUCT.adoc                                 │
│  [X] 3-practice/CONTRIBUTING.adoc                                    │
│  [X] FUNDING.yml                                          │
│  [X] 0-canon/GOVERNANCE.adoc                                      │
│  [X] REVERSIBILITY.md                                     │
│  [X] DEPENDENCIES.md                                      │
│  [X] ROADMAP.md                                           │
│  [X] COMPLIANCE.md                                        │
...
│     - 3-practice/SECURITY.md (add security contact)                   │
