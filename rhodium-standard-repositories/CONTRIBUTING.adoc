...
* link:3-practice/CODE_OF_CONDUCT.adoc[3-practice/CODE_OF_CONDUCT.adoc] - Community standards
* link:0-canon/GOVERNANCE.adoc[0-canon/GOVERNANCE.adoc] - Decision-making process
* link:3-practice/SECURITY.md[3-practice/SECURITY.md] - Security policies
...
See link:3-practice/MAINTAINERS.adoc[MAINTAINERS.md] for the progression path. Typically:
...
[source,git]
----
docs(readme): fix broken link to 0-canon/GOVERNANCE.adoc
...
3. Add `README.adoc`, `LICENSE.txt`, `3-practice/SECURITY.md`, etc.
...
See link:3-practice/MAINTAINERS.adoc[MAINTAINERS.md] for details.
...
All contributors must follow our link:3-practice/CODE_OF_CONDUCT.adoc[Code of Conduct].
...
* link:0-canon/GOVERNANCE.adoc[GOVERNANCE] - How decisions are made
* link:3-practice/SECURITY.md[SECURITY] - Security policies
* link:3-practice/MAINTAINERS.adoc[MAINTAINERS] - Team structure
