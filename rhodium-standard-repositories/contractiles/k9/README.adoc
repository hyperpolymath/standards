...
**ECOSYSTEM.a2ml**:: K9 can automate cross-repo operations using `.machine_readable/6a2/ECOSYSTEM.a2ml`
**META.a2ml**:: K9 can enforce architectural decisions recorded in `.machine_readable/6a2/META.a2ml`

NOTE: The estate migrated from Guile Scheme (STATE.scm, ECOSYSTEM.scm, META.scm) to
A2ML format on 2026-04-12. All references above use the current A2ML paths.
