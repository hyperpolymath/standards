...
[arabic]
. Go to
https://gitlab.com/hyperpolymath/rhodium-standard-repositories/-/issues/new
. Check "`This issue is confidential`"
. Add label: `+~security+`
...
Our canonical security contact is maintained in
...
The Rhodium Standard Repository framework employs defense-in-depth
across 10+ security dimensions:
...
. *Testing*: Fix verified by reporter (if willing)
. *Release*: Security advisory published with fix
. *Public disclosure*: 90 days after fix release (or sooner if agreed)
...
Published at: - GitLab Security Advisories:
https://gitlab.com/hyperpolymath/rhodium-standard-repositories/-/security/advisories
- Mailing list: `+security-announce@rhodium-standard.org+` - RSS feed:
https://rhodium-standard.org/security.rss

Format: https://github.com/advisories[GHSA-XXXX-YYYY-ZZZZ] compatible

=== Secure Development Practices

==== Code Review Requirements

All changes must: 1. Pass automated security tests 2. Be reviewed by at
least one maintainer 3. Include security impact assessment (for risky
changes) 4. Update threat model (if architecture changes)
...
Anticipated rewards: - *Critical*: $500-$2000 - *High*: $250-$500 -
*Medium*: $100-$250 - *Low*: $50-$100

Eligibility: - Follow responsible disclosure - No social engineering -
No DoS attacks on production - No automated scanning without permission
...
* https://www.erlang.org/doc/apps/ssl/ssl_protocol.html[Erlang/OTP
Security]
* https://learn.adacore.com/courses/intro-to-spark/index.html[SPARK
Proof Tutorials]
...
*Last Updated*: 2025-11-28 *Next Review*: 2026-01-28 *Policy Version*:
1.0.0

_"`Security is not a feature—it’s a continuous commitment to protecting
our community.`"_
