...
*Status:* FIRST PASS / RESEARCH *Purpose:* Integration with Public
Knowledge Project (OJS, OMP, OPS)

'''''

=== Background

The Public Knowledge Project (PKP) maintains the most widely-used
...
These platforms are critical infrastructure for academic publishing and
would be ideal targets for Palimpsest License integration.
...
[arabic]
. *How does PKP community governance work?*
