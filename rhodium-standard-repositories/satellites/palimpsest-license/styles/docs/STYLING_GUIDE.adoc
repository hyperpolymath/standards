...
This guide provides comprehensive instructions for using and customising
the Palimpsest License styling system. It covers design principles, best
...
*Solution:* 1. Ensure CSS is compiled: `+npm run build+` 2. Check file
path in HTML: `+<link href="styles/css/main.css">+` 3. Clear browser
cache 4. Check browser console for errors

===== Issue: Dark mode not working

*Solution:* 1. Verify browser supports `+prefers-color-scheme+` 2. Check
OS/browser theme settings 3. Use `+data-theme="dark"+` for manual
control

===== Issue: Focus styles not visible

*Solution:* 1. Ensure `+:focus-visible+` is supported 2. Check if
outline is overridden elsewhere 3. Test with keyboard navigation (Tab
key)
...
2. Test at specific breakpoint widths 3. Use browser dev tools device
emulation
...
Grid Guide]
* https://developer.mozilla.org/en-US/docs/Web/CSS/Reference[MDN - CSS
Reference]
