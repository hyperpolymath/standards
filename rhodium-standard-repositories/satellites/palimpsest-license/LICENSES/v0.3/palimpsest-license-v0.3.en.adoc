...
- Other translations must align with
...
* *Original Work*: A creative work with layered emotional, cultural, or
symbolic meaning +
...
(e.g. AI-generated text, environments) +
* *Thematic Integrity*: Preservation of emotional, cultural, or
narrative intent (see link:../examples/[`+examples/+`])
...
1.1 Attribution must reflect symbolic nature and cultural origin. Valid
forms:
...
1.2 See link:../docs/attribution-guide.md[`+docs/attribution-guide.md+`]
...
9.3 Creators may revoke rights via public notice in
...
10.2 Version updates tracked in
