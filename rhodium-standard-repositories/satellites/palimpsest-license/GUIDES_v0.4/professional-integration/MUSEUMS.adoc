...
Museums hold cultural memory. In the AI era, this creates new
responsibilities:
...
* ICOM: https://icom.museum[icom.museum]
* Collections Trust:
https://collectionstrust.org.uk[collectionstrust.org.uk]
* AAM: https://www.aam-us.org[aam-us.org]

==== Technical Standards

* LIDO: http://lido-schema.org[lido-schema.org]
* IIIF: https://iiif.io[iiif.io]
* SPECTRUM:
https://collectionstrust.org.uk/spectrum/[collectionstrust.org.uk/spectrum]
