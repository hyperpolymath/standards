...
When you complete a sync: 1. Move repo from "`Phase 1`" to "`Completed
Syncs`" 2. Add date and notes 3. Commit this file with message:
`+docs: update migration status - synced {repo}+`
