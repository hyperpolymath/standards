...
=== https://github.com/Hyperpolymath/STATE.scm/compare/v1.0.0...v2.0.0[2.0.0] - 2025-12-06
...
=== https://github.com/Hyperpolymath/STATE.scm/releases/tag/v1.0.0[1.0.0] - 2025-12-06
