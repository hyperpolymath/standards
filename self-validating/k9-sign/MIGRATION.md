...
2. **Announce key rotation:**
   ...
   Please:
   1. Install k9-sign: https://github.com/hyperpolymath/self-validating/tree/main/k9-sign
...
- **Issues:** https://github.com/hyperpolymath/standards/tree/main/self-validating/issues
