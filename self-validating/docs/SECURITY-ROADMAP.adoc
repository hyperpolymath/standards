...
**Status Tracking:** https://github.com/hyperpolymath/standards/tree/main/self-validating/projects/security-roadmap
...
**Tasks:**
- [ ] Update all docs: "Hunt" → "Production"
- [ ] Update all docs: "Unleash" → "Deploy"
- [ ] Update all docs: "Active pedigree" → "Embedded validation"
...
- ✅ k9-sign (Rust) passes all tests and fuzzing
- ✅ Refuses to run as root by default
- ✅ k9-scan detects dangerous patterns
- ✅ Dry-run mode works
...
- ✅ Hardware keys supported and documented
- ✅ Key revocation system works
- ✅ Nickel sandboxed
- ✅ Hunt-level sandbox available
- ✅ Reproducible builds
- ✅ Security audit complete with public report
...
- [ ] Extract verified code (Coq → Rust)
- [ ] Integration testing
...
- ✅ Bug bounty program active (6+ months)
...
**Project Board:** https://github.com/hyperpolymath/standards/tree/main/self-validating/projects/security-roadmap +
