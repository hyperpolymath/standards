...
4. **Report to K9 maintainers**
   - Email: security@self-validating.org (not yet active, use GitHub Security)
   - GitHub: https://github.com/hyperpolymath/standards/tree/main/self-validating/security/advisories/new
