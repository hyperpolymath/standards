...
cache_dir="$HOME/.cache/self-validating/eval"
...
3. **File an issue:** https://github.com/hyperpolymath/standards/tree/main/self-validating/issues
4. **Include:**
