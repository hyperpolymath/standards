...
| `deploy.k9.ncl`
| **self-validating** deployment component at Hunt trust level. Full pedigree
...
**self-validating** (deployment components)::
...
For self-validating managed deployments:
...
self-validating deploy container/deploy.k9.ncl --env production
----
