...
| `testing/`                        | The estate-wide language-testing
                                     standard, its AffineScript and Julia
                                     guides, and the per-language guide
                                     template. These belong with toolchain
                                     readiness rather than an unregistered
                                     root-level reorganisation directory.
