...
=== 1. Create an ECOSYSTEM.a2ml file
...
=== 3. Integrate with STATE.a2ml (Optional)
...
=== STATE.a2ml (Sibling Standard)

Session state persistence for AI conversation continuity.

* Repository: link:../state-a2ml/[state-a2ml]
...
* Discussions: https://github.com/hyperpolymath/standards/discussions
