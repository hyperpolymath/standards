...
STATE file::
  A file conforming to this specification. The current format uses A2ML (TOML-like)
  syntax and is named `STATE.a2ml`, located in `.machine_readable/descriptiles/STATE.a2ml`.
  The legacy Guile Scheme format (`STATE.scm`) is deprecated as of 2026-04-12.
...
Additional information:
  File extension(s): .a2ml (current), .scm (deprecated legacy format)
...
The current recommended file extension is `.a2ml` with filename `STATE.a2ml`,
placed at `.machine_readable/descriptiles/STATE.a2ml`.

The legacy extension `.scm` (Guile Scheme format) is deprecated as of 2026-04-12.
Legacy files are preserved for archival reference only.
