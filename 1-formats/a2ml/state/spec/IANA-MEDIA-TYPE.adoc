...
* Repository: https://github.com/hyperpolymath/standards (1-formats/a2ml/state/ subdirectory; previously at github.com/hyperpolymath/state.scm)
...
`.a2ml`::
  Current A2ML format extension (RECOMMENDED). Files named `STATE.a2ml`,
  placed at `.machine_readable/descriptiles/STATE.a2ml`.

`.scm`::
  DEPRECATED legacy Guile Scheme extension. Preserved for archival reference.
  The estate migrated to `.a2ml` on 2026-04-12.

`.state`::
  Alternative STATE-specific extension (historical; `.a2ml` preferred)
