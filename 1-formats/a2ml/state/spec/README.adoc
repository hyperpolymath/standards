...
# Convert STATE.a2ml to JSON, then validate
# (Requires conversion tool - see lib/ for implementation)
# Note: legacy STATE.scm format is deprecated as of 2026-04-12
...
See link:../CONTRIBUTING.adoc[3-practice/CONTRIBUTING.adoc] for contribution guidelines.
