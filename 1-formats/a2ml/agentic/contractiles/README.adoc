...
This directory contains the generalized contractiles templates. Copy the `1-formats/contractiles/` directory into a new repo to establish a consistent operational, validation, trust, recovery, and intent framework.
