...
1.0.0-alpha.1    Internal dogfooding under real use and breakage
1.0.0-beta.1     External release exposure beyond the originating repo
...
`1.0.0` denotes audited stability, not mere feature completion.

Before any specification or implementation in this ecosystem claims stable
`1.0.0`, it MUST satisfy the organization-wide
link:../../release-pre-flight/V1-GATE.adoc[Stable Release Gate].

If the full audit is incomplete, the version MUST remain `draft`, `alpha`,
`beta`, or `rc`, regardless of implementation maturity.
