...
toolbox create k9-svc-dev toolbox enter k9-svc-dev # Install
...
1-formats/k9/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library code
...
README.adoc ├── 3-practice/SECURITY.md ├── guix.scm # Guix manifest (Perimeter 1) └──
