...
|Hunt
|Multi-service container deployment with rolling deploy, rollback,
cerro-torre image verification, and 3 environments (dev/staging/prod).

|`NOT-a-good-fit.adoc`
|N/A (documentation)
|Honest comparison of 1-formats/k9/a2ml vs alternatives (Helm, Kustomize, Terraform, etc.).
5 DEPRECATE and 10 KEEP verdicts with decision flowchart.
|===

== Container Image

The project Containerfile uses **Chainguard wolfi-base** (not Debian).
...
See link:GUIDE.adoc[GUIDE.adoc] for the full container deployment walkthrough,
including security level selection guidance.
...
# Security tools
./k9-scan https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/hello.k9        # Static analysis
./must verify https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/hello.k9    # Signature verification
./must --dry-run run https://github.com/hyperpolymath/k9-ecosystem/blob/main/examples/hello.k9  # Preview mode
----
...
* **Report vulnerabilities:** See link:3-practice/SECURITY.md[Security Policy]
