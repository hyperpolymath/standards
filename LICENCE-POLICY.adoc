...
=== Rule 1 — MPL-2.0 for Code, CC-BY-4.0 for Prose Docs
...
narrative docs under CC-BY-4.0 — unless Rule 2 or Rule 3 applies. The
`LICENSES/` directory carries the canonical text for both
(`MPL-2.0.txt`, `CC-BY-4.0.txt`).
...
MPL-2.0 (code) / CC-BY-4.0 (docs) per Rule 1, both as the *stated* and the
...
| `CC-BY-4.0`
| Owner ruling 2026-06-04 — narrative docs are CC-BY; code stays MPL-2.0
