...
| HYP-S006 | `profile-drift-detector` | Flag a 6a2 file whose content drifts from its declared A2ML `@profile` |

HYP-S006 closes the dogfooding loop for the A2ML profile mechanism: every 6a2
...
- `a2ml/profiles/REGISTRY.a2ml` + `a2ml/profiles/*/PROFILE.a2ml` and the 6a2
  files under `.machine_readable/` (HYP-S006)
