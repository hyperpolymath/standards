...
- **Add/move a spec:** edit the `SPECS` table in `scripts/build-registry.sh`,
  then `just registry` (regenerates `REGISTRY.a2ml` + `TOPOLOGY.md`). CI rejects
  a spec change that forgets to regenerate (`registry-verify.yml`).
