...
|hypatia `:typescript_detected` rule + `path_allow_prefixes` (9 carve-out classes); standards `.claude/CLAUDE.md` exemption table; `3-practice/LANGUAGE-POLICY.adoc` Banned TS row; `language-policy.yml` CI gate. Layer-1 PRs: hypatia#375, hypatia#378, standards#235, standards#238, reposystem#82.
|Complete
