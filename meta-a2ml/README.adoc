...
the DEED grammar specification -- `1-formats/deed/spec/DEED-GRAMMAR-SPEC.adoc` in this
...
* https://github.com/hyperpolymath/standards/blob/main/SATELLITES.a2ml[1-formats/SATELLITES.a2ml] -- Machine-readable satellite registry
