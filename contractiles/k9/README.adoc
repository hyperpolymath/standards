...
For the estate-level meaning of `Must`, `Trust`, `Dust`, `Intent`, and how
`k9` is supposed to enforce or validate them, see
link:../CANONICAL-TEMPLATES.adoc[Canonical Contractiles And K9 Guide].
